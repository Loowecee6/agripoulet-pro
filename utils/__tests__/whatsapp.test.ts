...
describe('formatWhatsAppUrl', () => {
  it('formats a local number with country code', () => {
    ...
    expect(result).toBe('https://wa.me/221102030405');
  });

  it('formats a number already with country code', () => {
    const result = formatWhatsAppUrl('2210102030405');
    expect(result).toBe('https://wa.me/2210102030405');
  });
  ...
  it('encodes a message parameter', () => {
    ...
    expect(result).toBe('https://wa.me/221102030405?text=Bonjour%20!');
  });

  it('encodes a message with special characters', () => {
    const result = formatWhatsAppUrl('0102030405', 'Hello\nWorld');
    expect(result).toBe('https://wa.me/221102030405?text=Hello%0AWorld');
  });
  ...
  it('handles number starting with +221 prefix', () => {
    const result = formatWhatsAppUrl('+2210102030405');
    expect(result).toBe('https://wa.me/2210102030405');
  });
